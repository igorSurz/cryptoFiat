			...
			<div className="content">
							...
							<CardHeader>
								<Row>
									<Col className="text-left" sm="6">
										<h5 className="card-category">Total Price</h5>
										<CardTitle tag="h2">Bitcoin [BTC]</CardTitle>
									</Col>
									<Col sm="6">
				...
				<Row>
					<Col lg="6">
						<Card className="card-chart">
							<CardHeader>
								<h5 className="card-category">Total Deals Volume</h5>
								<CardTitle tag="h3">
									<i className="tim-icons icon-bell-55 text-info" /> 4564
								</CardTitle>
							</CardHeader>
							<CardBody>
								<div className="chart-area">
					...
					<Col lg="6">
						<Card className="card-chart">
							<CardHeader>
								<h5 className="card-category">Daily Deals Amount</h5>
								<CardTitle tag="h3">
				...
				<Row>
					...
					<Col lg="12" md="12">
						<Card>
							<CardHeader>
								<CardTitle tag="h4">Recent Deals</CardTitle>
							</CardHeader>
							<CardBody>
